...
var primaryDeployment = {
  workloadTags: {
    ...
    HubGroupName: isNetworkIsolated == 'true' ? naming.outputs.resourceNames.hubResourceGroup : naming.outputs.resourceNames.resourceGroup
  }
}
...
var secondDeployment = {
  ...
  workloadTags: {
    ...
    HubGroupName: isNetworkIsolated == 'true' ? naming.outputs.resourceNames.hubResourceGroup : ''
  }
}
...
module applicationPostConfiguration './modules/application-post-config.bicep' = {
  ...
  params: {
    ...
    administratorUsername: administratorUsername
    databasePassword: databasePassword
    hubResourceGroupName: isNetworkIsolated? resourceGroups.outputs.hub_resource_group_name : resourceGroups.outputs.application_resource_group_name
